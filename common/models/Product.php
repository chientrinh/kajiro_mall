...
class Product extends \yii\db\ActiveRecord
{
    ...
    const PKEY_NOTO_SUPPORT         = 4840; // 能登地震災害支援
 ...
 //   public $client_id = null;
    ...
    public function rules()
    {
        return [
            ...
            [['category_id', 'price', 'restrict_id','in_stock', 'recommend_flg', 'recommend_seq', 'liquor_flg', 'upper_limit', 'tax_id', 'cool_id', 'pre_order'], 'integer'],
            [['sodan_flg','client_id','name','kana','summary','description'], 'string'],
            ...
            [['vender_key', 'bunrui_code1', 'bunrui_code2', 'bunrui_code3', 'sku_id', 'keywords', 'cool_id', 'pre_order'], 'safe'],
        ];
    }
