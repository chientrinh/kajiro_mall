...
class Product extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['category_id', 'price', 'restrict_id','in_stock', 'recommend_flg', 'recommend_seq', 'liquor_flg', 'upper_limit', 'tax_id'], 'integer'],
            ...
            [['vender_key', 'bunrui_code1', 'bunrui_code2', 'bunrui_code3', 'sku_id', 'keywords'], 'safe'],
        ];
    }
